...
## 补充功能
 - 增加阿里云OSS图片处理持久化功能
 - ![success](/doc/success.jpg)
 - ![demo](/doc/demo.jpg)
 - 原图：[https://itsvse.oss-cn-hangzhou.aliyuncs.com/test/itsvse.jpg](https://itsvse.oss-cn-hangzhou.aliyuncs.com/test/itsvse.jpg)
 - 处理后：[https://itsvse.oss-cn-hangzhou.aliyuncs.com/test/itsvse_demo.jpg](https://itsvse.oss-cn-hangzhou.aliyuncs.com/test/itsvse_demo.jpg)
 - [OSS图片处理6.0工具](https://gosspublic.alicdn.com/image/index.html)
#### 代码（Process Object）
```csharp
