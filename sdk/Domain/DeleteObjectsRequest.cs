...
namespace Aliyun.OSS
{
    ...
    public class DeleteObjectsRequest
    {
        ...
        /// <summary>
        /// Creates an <see cref="DeleteObjectRequest"/> instance with bucket name and keys. Quiet mode is true by default.
        /// </summary>
        ...
        /// <summary>
        /// Creates an <see cref="DeleteObjectRequest"/> instance with bucket name, keys and quiet flag.
        /// </summary>
        /// <param name="bucketName">bucket name</param>
